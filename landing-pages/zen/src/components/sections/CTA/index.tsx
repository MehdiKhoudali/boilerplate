...
const CTA = () => {
	return (
		<div className="w-full min-h-fit md:min-h-[500px] rounded-lg border border-slate-400/20 relative overflow-hidden flex items-center justify-center gap-6 px-3 py-6 sm:p-8 md:p-16 flex-col">
			<Gradient />
			<svg
				width="66"
				height="50"
			...
			<div className="flex flex-col items-center justify-center gap-4">
				...
				<p className="text-white/70 text-center md:text-sm text-base">
					Join our Discord community to get the latest updates, share{" "}
					<br className="hidden md:block" /> your thoughts, and connect with
					other developers.
				</p>
